...
const Navbar = ({ isDark, setIsDark }: Props) => {
            ...
            <nav className='sticky border-b-2 border-black bg-white dark:bg-slate-900 dark:border-white'>
                <div className='flex justify-between mx-auto container py-5 items-center transition-all px-2'>
                    ...
                    <ul className='hidden md:flex space-x-4'>
                        <li className='hoverTransition'><a href='/#about'>about me</a></li>
                        <li className='hoverTransition'><a href='/#blog'>blog</a></li>
                        <li className='hoverTransition'><a href='/#portfolio'>portfolio</a></li>
                        <li className='hoverTransition'><a href='/#contact'>contact</a></li>
                    </ul>
    ...
    bg-white z-20 transition-all opacity-95 block w-full p-10 rounded-b-xl space-y-10 border-b-4 border-black text-center md:hidden dark:border-white dark:bg-slate-900`}
            >
                <li className='hoverTransition'><a onClick={() => setOpenMenu(!openMenu)} href='/#about'>about me</a></li>
                <li className='hoverTransition'><a onClick={() => setOpenMenu(!openMenu)} href='/#blog'>blog</a></li>
                <li className='hoverTransition'><a onClick={() => setOpenMenu(!openMenu)} href='/#portfolio'>portfolio</a></li>
                <li className='hoverTransition'><a onClick={() => setOpenMenu(!openMenu)} href='/#contact'>contact</a></li>
            </ul>
        </div>
    )
}
