        ...
        <div id='#'>
            <div className='grid md:grid-cols-2 gap-4'>
                ...
                <div className='text-right border-2 border-black p-4 space-y-5 shadow-lg dark:border-white'>
                    ...
                    <p>i am currently running an early-phase startup, solving issues in the education industry, with another co-founder. contact me for any business purposes.</p>
                    <div className='mt-5' />
