...
const Contact = () => {
  return (
    <div
      id="contact"
      className="space-y-3 p-10 border-2 border-black shadow-lg dark:border-white"
    >
      ...
      <div className="grid md:grid-cols-2 gap-3">
        <div>
          <a
            href="mailto:joylodra@gmail.com"
            target="_blank"
        ...
        <div>
          <a
            href="https://www.youtube.com/c/DSKWShorts"
            target="_blank"
            className="cursor-pointer"
          >
            <div className="flex justify-center gap-3 items-center p-3 border-2 border-black shadow-lg hover:scale-95 transition duration-200 dark:border-white">
        ...
        <div>
          <a
            href="https://tiktok.com/@joooyyyyyyyyyy"
            target="_blank"
            className="cursor-pointer"
          >
            <div className="flex justify-center gap-3 items-center p-3 border-2 border-black shadow-lg hover:scale-95 transition duration-200 dark:border-white">
