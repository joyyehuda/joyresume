...
const About = () => {
  return (
    <div
      id="about"
      className="gap-10 flex flex-col items-center md:grid md:grid-cols-2 transition-all"
    >
      ...
      <div className="text-left space-y-1">
        ...
        <p>
          as a tech co-founder, it's important to pick up certain software
          development skills. the bars below indicate the level of my ability to
          work with the tools and technologies.
        </p>
